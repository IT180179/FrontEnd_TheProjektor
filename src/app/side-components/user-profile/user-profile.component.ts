...
export class UserProfileComponent implements OnInit {
  ...
  constructor(private router: Router, private auth: AuthService, private snackBar: MatSnackBar, public http: HttpClient, private service: HttpService, public dataService: DataService) {
  }
  employees: any;
  fachkoordinator: any;
  project: any;
